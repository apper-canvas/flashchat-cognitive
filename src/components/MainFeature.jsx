            ...
            <div className="flex items-center justify-between px-6 pb-6">
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  className="w-12 h-12 bg-primary rounded-full flex items-center justify-center border border-primary/20 hover:bg-primary/90 transition-all"
                >
                  <ApperIcon name="User" className="w-6 h-6 text-black" />
                </button>
              </div>
